        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.update',$user->id) }}" name="email" enctype="multipart/form-data">
                    {{method_field('PUT')}}
                        @csrf
                        @isset($user)
                        ...
                        <div class="form-group row">
                            <label  class="col-md-4 col-form-label text-md-right">現在のメールアドレス</label>
